...
using Application.Client.Core.Application.Configurations;
using Application.Client.Core.Application.Extensions;
...
namespace Application.Client
{
    public partial class App
    {
        ...
        private static void ConfigureServices(IHostEnvironment hostEnvironment, IConfiguration configuration, IServiceCollection services)
        {
            services.AddDbContext<ParkingAppDbContext>(options =>
                options.UseSqlServer(
                    configuration.GetConnectionString($"{hostEnvironment.EnvironmentName}Connection")
                )
            );
